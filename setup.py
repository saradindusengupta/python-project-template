...
setup(
    ...
    description="Awesome python_project_template created by saradindusengupta",
    url="https://github.com/saradindusengupta/python-project-template/",
    long_description=read("README.md"),
    long_description_content_type="text/markdown",
    author="saradindusengupta",
